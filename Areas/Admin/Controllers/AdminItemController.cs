...
namespace PROJETO.Areas.Admin.Controllers
{
    ...
    public class AdminItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemPequenaUrl,ImagemUrl,Destaque,CategoriaId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemPequenaUrl,ImagemUrl,Destaque,CategoriaId")] Item item)
        {
            if (id != item.ItemId)
            {
                return NotFound();
